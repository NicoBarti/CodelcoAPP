...
class ContactosTest < ApplicationSystemTestCase
  ...
  test "creating a Contacto" do
    ...
    fill_in "Episode", with: @contacto.episode_id
    fill_in "Fecha investigacion", with: @contacto.fecha_investigacion
    fill_in "Parentesco", with: @contacto.parentesco
    fill_in "Tipo contacto", with: @contacto.tipo_contacto
