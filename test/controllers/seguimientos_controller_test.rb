...
class SeguimientosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seguimiento" do
    assert_difference('Seguimiento.count') do
      post seguimientos_url, params: { seguimiento: { estado_seguimiento: @seguimiento.estado_seguimiento, estadoegreso: @seguimiento.estadoegreso, evolucion: @seguimiento.evolucion, falleceresp: @seguimiento.falleceresp, hospitalizacion: @seguimiento.hospitalizacion, references: @seguimiento.references, tipo_aislamiento: @seguimiento.tipo_aislamiento, ventilacion: @seguimiento.ventilacion } }
    end
  ...
  test "should update seguimiento" do
    patch seguimiento_url(@seguimiento), params: { seguimiento: { estado_seguimiento: @seguimiento.estado_seguimiento, estadoegreso: @seguimiento.estadoegreso, evolucion: @seguimiento.evolucion, falleceresp: @seguimiento.falleceresp, hospitalizacion: @seguimiento.hospitalizacion, references: @seguimiento.references, tipo_aislamiento: @seguimiento.tipo_aislamiento, ventilacion: @seguimiento.ventilacion } }
